...
export const STRINGS: Record<LocaleCode, Strings> = {
  en: {
    ...
    browserWarningMessage: 'tele.me works best in Chrome due to compatibility limitations. There are known bugs when used in different browsers.',
    continue: 'Continue',
    confirm: 'Confirm',
    clearAll: 'Clear all',
    ...
    popOutOnlyChrome: 'Pop out mode is not possible on Safari'
  },
  es: {
    defaultScript:
      'Tu guion va aquí.\n\n' +
    ...
    browserWarningMessage: 'tele.me funciona mejor en Chrome debido a limitaciones de compatibilidad. Hay errores conocidos al usar otros navegadores.',
    continue: 'Continuar',
    confirm: 'Confirmar',
    ...
    popOutOnlyChrome: 'El modo de ventana emergente no es posible en Safari'
  },
  ja: {
    defaultScript:
      'ここにスクリプトを書きます。\n\n' +
    ...
    browserWarningMessage: 'tele.meは互換性の制限により、Chromeで最もよく動作します。他のブラウザで使用する場合、既知のバグがあります。',
    continue: '続ける',
    confirm: '確認',
    clearAll: 'すべて削除',
    ...
    popOutOnlyChrome: 'Safariではポップアウトモードは利用できません'
  },
  hi: {
    defaultScript:
    ...
    browserWarningMessage: 'tele.me अनुकूलता सीमाओं के कारण Chrome में सबसे अच्छा काम करता है। विभिन्न ब्राउज़रों में उपयोग करने पर ज्ञात बग हैं।',
    continue: 'जारी रखें',
    confirm: 'पुष्टि करें',
    ...
    popOutOnlyChrome: 'Safari पर पॉप आउट मोड संभव नहीं है'
  },
  fr: {
    defaultScript:
      'Votre script va ici.\n\n' +
    ...
    browserWarningMessage: "tele.me fonctionne mieux dans Chrome en raison de limitations de compatibilité. Il existe des bugs connus lors de l'utilisation dans d'autres navigateurs.",
    continue: 'Continuer',
    confirm: 'Confirmer',
    ...
    popOutOnlyChrome: 'Le mode fenêtre surgissante n’est pas possible sur Safari'
  },
  de: {
    defaultScript:
    ...
    browserWarningMessage: 'tele.me funktioniert aufgrund von Kompatibilitätseinschränkungen am besten in Chrome. Es gibt bekannte Fehler bei der Verwendung in anderen Browsern.',
    continue: 'Fortfahren',
    confirm: 'Bestätigen',
    ...
    popOutOnlyChrome: 'Der Pop-out-Modus ist in Safari nicht möglich'
  },
  zh: {
    defaultScript:
      '你的脚本写在这里。\n\n' +
    ...
    browserWarningMessage: '由于兼容性限制，tele.me在Chrome中效果最佳。在其他浏览器中使用时存在已知错误。',
    continue: '继续',
    confirm: '确认',
    clearAll: '全部清除',
    ...
    popOutOnlyChrome: 'Safari 上不支持弹出模式'
  },
  ar: {
    defaultScript:
      'ضع النص هنا.\n\n' +
    ...
    browserWarningMessage: 'يعمل tele.me بشكل أفضل في Chrome بسبب قيود التوافق. توجد أخطاء معروفة عند الاستخدام في متصفحات مختلفة.',
    continue: 'متابعة',
    confirm: 'تأكيد',
    clearAll: 'مسح الكل',
    ...
    popOutOnlyChrome: 'وضع النافذة المنبثقة غير ممكن على Safari'
  },
  pt: {
    defaultScript:
      'Seu script vai aqui.\n\n' +
    ...
    browserWarningMessage: 'tele.me funciona melhor no Chrome devido a limitações de compatibilidade. Existem bugs conhecidos ao usar em outros navegadores.',
    continue: 'Continuar',
    confirm: 'Confirmar',
    ...
    popOutOnlyChrome: 'O modo pop-out não é possível no Safari'
  },
  ru: {
    defaultScript:
      'Ваш текст здесь.\n\n' +
    ...
    browserWarningMessage: 'tele.me лучше всего работает в Chrome из-за ограничений совместимости. При использовании в других браузерах есть известные ошибки.',
    continue: 'Продолжить',
    confirm: 'Подтвердить',
    ...
    popOutOnlyChrome: 'Вынос окна невозможен в Safari'
  },
  pl: {
    defaultScript:
      'Twój tekst tutaj.\n\n' +
    ...
    browserWarningMessage: 'tele.me działa najlepiej w Chrome ze względu na ograniczenia kompatybilności. Istnieją znane błędy podczas używania w innych przeglądarkach.',
    continue: 'Kontynuuj',
    confirm: 'Potwierdź',
    ...
    popOutOnlyChrome: 'Tryb wyskakującego okna nie jest możliwy w Safari'
  },
}
