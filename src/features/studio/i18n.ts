...
export const STRINGS: Record<LocaleCode, Strings> = {
  en: {
    ...
    savedScriptsInfo: 'Saved locally (max 10).',
  ...
  es: {
    ...
    savedScriptsInfo: 'Guardados localmente (máx. 10).',
  ...
  ja: {
    ...
    savedScriptsInfo: 'ローカルに保存 (最大 10 件)。',
  ...
  hi: {
    ...
    savedScriptsInfo: 'स्थानीय रूप से सहेजा गया (अधिकतम 10)।',
  ...
  fr: {
    ...
    savedScriptsInfo: 'Enregistrés localement (max. 10).',
  ...
  de: {
    ...
    savedScriptsInfo: 'Lokal gespeichert (max. 10).',
  ...
  ar: {
    ...
    savedScriptsInfo: 'محفوظة محلياً (بحد أقصى 10).',
  ...
  pt: {
    ...
    savedScriptsInfo: 'Salvos localmente (máx. 10).',
  ...
  ru: {
    ...
    savedScriptsInfo: 'Сохраняются локально (макс. 10).',
  ...
  pl: {
    ...
    savedScriptsInfo: 'Zapisywane lokalnie (maks. 10).',
